...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <center>
                        <div class="card-header">Show Mobil</div>
                    </center>
                    ...
                    <div class="card-body">
                        <form action="{{route('mobil.show', $mobil->id)}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{$mobil->kode_mobil}}" type="text" name="kode_mobil"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Merk</label>
                                <input class="form-control" value="{{$mobil->merk}}"type="text" name="merk"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Type</label>
                                <input class="form-control" value="{{$mobil->type}}"type="text" name="type"disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{$mobil->harga_mobil}}"type="text" name="harga_mobil"disabled>
                            </div>
                            <div class="form-group">
