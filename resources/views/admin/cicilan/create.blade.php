...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <center>
                        <div class="card-header">Tambah Cicilan</div>
                    </center>
                    ...
                    <div class="card-body">
                        <form action="{{route('cicilan.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" name="tgl_cicilan" id="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Cicilan Harga Ke</label>
                                <input class="form-control" type="text" name="cicilan_harga_ke" id="">
                            </div>
                            <div class="form-group">
