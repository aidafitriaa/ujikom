...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <center>
                        <div class="card-header">Show Paket Kredit</div>
                    </center>
    
                    <div class="card-body">
                        <form action="{{route('paket_kredit.show', $paket_kredit->id)}}" method="POST">
                            <input type="hidden" name="_method" value="PATCH">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="">Kode Paket</label>
                                <input class="form-control" value="{{$paket_kredit->kode_paket}}" type="text" name="kode_paket"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Harga Paket</label>
                                <input class="form-control" value="{{$paket_kredit->harga_paket}}"type="text" name="harga_paket"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Uang Muka</label>
                                <input class="form-control" value="{{$paket_kredit->uang_muka}}"type="text" name="uang_muka"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Jumlah Cicilan</label>
                                <input class="form-control" value="{{$paket_kredit->jumlah_cicilan}}"type="text" name="jumlah_cicilan"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Bunga</label>
                                <input class="form-control" value="{{$paket_kredit->bunga}}"type="text" name="bunga"disabled>
                            </div>
                             <div class="form-group">
                                <label for="">Nilai Cicilan</label>
                                <input class="form-control" value="{{$paket_kredit->nilai_cicilan}}"type="text" name="nilai_cicilan"disabled>
                            </div>
                            <div>
                                <div class="form-group">
