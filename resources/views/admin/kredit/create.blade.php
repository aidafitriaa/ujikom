                    ...
                    <div class="card-body">
                        <form action="{{route('kredit.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="paket_kredits_id" id="">
                            </div>
                            <div class="form-group">
                                <label for="">Kode Mobil</label>
                                <input class="form-control" type="text" name="mobils_id" id="">
                            </div>
                            <div class="form-group">
                                <label for="">Tanggal Kredit</label>
                                <input class="form-control" type="date" name="tgl_kredit" id="">
                            </div>
                            <div class="form-group">
