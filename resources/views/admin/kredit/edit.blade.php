...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <center>
                        <div class="card-header">Edit Paket Kredit</div>
                    </center>
                    ...
                    <div class="card-body">
                        <form action="{{route('kredit.update', $kredit->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{$kredit->paket_kredits_id}}"type="text" name="paket_kredits_id">
                            </div>
                            <div class="form-group">
                                <label for="">Id Mobil</label>
                                <input class="form-control" value="{{$kredit->mobils_id}}"type="text" name="mobils_id">
                            </div>
                            <div class="form-group">
